...
bool is_port_speed_map_initialized = false;


struct performance_data perf_data = { .port_name = "", .curr_speed = 0 };
pthread_mutex_t perf_data_lock = PTHREAD_MUTEX_INITIALIZER;
//joo)
